...
if SLACK_BOT_TOKEN and SLACK_SIGNING_SECRET:
    ...
    slack_app = None
    handler = None
    logger.warning("Slack tokens are not set. Slack integration is disabled.")
...
# Ensure Slack integration is enabled before registering events
if slack_app:
    ...
    logger.info("Slack event handlers are not registered because Slack integration is disabled.")